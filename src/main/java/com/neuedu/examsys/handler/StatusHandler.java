...
import com.neuedu.examsys.domain.Status;
...
public class StatusHandler extends BaseTypeHandler<Status> {
	...
	public Status getNullableResult(ResultSet rs, String columnName) throws SQLException {
		...
		if (rs.wasNull()) {
			...
			return Status.getStatusByKey(key);
		}
	}
	 ...
	 */
	@Override
	public void setNonNullParameter(PreparedStatement ps, int i, Status param, JdbcType jdbcType) throws SQLException {
